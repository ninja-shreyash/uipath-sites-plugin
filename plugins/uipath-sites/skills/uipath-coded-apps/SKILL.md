...
This bundled version is adapted for Codex. When the workflow says to ask the user for app type, environment, client ID, or any other required input, ask directly in normal Codex style before proceeding. Do not rely on Claude-specific question tools.
