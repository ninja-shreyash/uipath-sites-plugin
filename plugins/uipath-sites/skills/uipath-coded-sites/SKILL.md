...
- Apply the frontend styling rules in [references/frontend-design-overrides.md](references/frontend-design-overrides.md) when generating or modifying the coded app UI.
